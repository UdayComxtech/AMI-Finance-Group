    ...
    if (!function_exists('ulpb_available_pro_widgets') ) { $isPremUser = false; }
      ...
      for ($j = 0; $j < count($colWidgets); $j++) {  // widgets loop
          ...
          if ($this_column_type == 'wigt-menu') {
            ...
            switch($menuStyle){
              case 'menu-style-1':
                $menuStylePath = "menu-style-1";
              break;
              case 'menu-style-2':
                $menuStylePath = "menu-style-2";
              break;
              case 'menu-style-3':
                $menuStylePath = "menu-style-3";
              break;
              case 'menu-style-4':
                $menuStylePath = "menu-style-4";
              break;
              default:
              $menuStylePath = "menu-style-1";
            }

            if ($menuStylePath == 'menu-style-1' || $menuStylePath == 'menu-style-4') {
              $menuSpecificStyles = "display: flex; justify-content: center; align-items: center;";
            } elseif ($menuStylePath == 'menu-style-2') {
              $menuSpecificClass = "widget-$j-menuFixed";
            }

            include(ULPB_PLUGIN_PATH.'public/templates/menus/'.$menuStylePath.'.php');
